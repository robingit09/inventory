Public Class Ledger
    ...
    Private Sub dgvLedger_CellMouseDown(sender As Object, e As DataGridViewCellMouseEventArgs) Handles dgvLedger.CellMouseDown
    ...
    Private Sub CheckNotificationToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CheckNotificationToolStripMenuItem.Click
