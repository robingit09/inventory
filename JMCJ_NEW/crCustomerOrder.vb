...
Public Class crCustomerOrder
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JMCJ_NEW.crCustomerOrder.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCustomerOrder
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCustomerOrder = New crCustomerOrder()
        rpt.Site = Me.Site
        Return rpt
    End Function
